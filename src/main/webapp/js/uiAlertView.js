(function($) {
        ...
        $(divName).css( { position : 'absolute', 'top' : top + scrollTop, 'left' : '50%'} ).show();  
    }  
    $.extend({
        alertView: function(options) {
            ...
            if (settings.showMask) {
                ...
                $(".pop-content").append('<div id="popup-dialog-mask" class="lodding-mask"></div>');
            	}else{
